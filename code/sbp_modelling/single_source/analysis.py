...
import os
import pandas as pd
from sbp_modelling.single_source.model import SingleSourceModel
from sbp_modelling.single_source.forward_model import source_xz, a_x_s, a_z_s, seeds
...
csv_path = '../../../results/single-source/rms-amplitudes.csv'
