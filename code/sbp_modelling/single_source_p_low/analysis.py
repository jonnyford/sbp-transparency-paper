...
from sbp_modelling.single_source_p_low.model import SingleSourceModel, v_p_0, v_p_1
from sbp_modelling.single_source_p_low.forward_model import source_xz, a_x_s, a_z_s, seeds
from sbp_modelling.analysis import envelope
from examples.seismic import RickerSource, TimeAxis

results_path = '../../../results/single-source-p-low/traces.npz'
results_path = os.path.realpath(os.path.join(os.path.dirname(__file__), results_path))
csv_path = '../../../results/single-source-p-low/rms-amplitudes.csv'
