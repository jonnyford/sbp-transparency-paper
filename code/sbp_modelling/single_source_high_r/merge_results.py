import numpy as np
from sbp_modelling.single_source_high_r.forward_model import results_path, a_x_s, a_z_s, seeds
from pathlib import Path

n_tasks = None

with open(Path(__file__).parent.resolve() / 'single_source_high_r.job') as f:
