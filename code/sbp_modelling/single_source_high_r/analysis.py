...
import os
import pandas as pd
from sbp_modelling.single_source_high_r.model import SingleSourceModel
from sbp_modelling.single_source_high_r.forward_model import source_xz, a_x_s, a_z_s, seeds
from sbp_modelling.analysis import envelope

results_path = '../../../results/single-source-high-r/traces.npz'
results_path = os.path.realpath(os.path.join(os.path.dirname(__file__), results_path))
csv_path = '../../../results/single-source-high-r/rms-amplitudes.csv'
